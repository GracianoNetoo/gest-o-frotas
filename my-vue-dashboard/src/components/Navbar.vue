    ...
    <section class="flex-1">
      <div class="form-control">
        <input
          type="text"
          placeholder="Search"
          class="input input-bordered w-46 ml-2 md:w-auto dark:bg-white/5 dark:backdrop-blur-md dark:[--webkit-backdrop-filter:blur(10px)] dark:border-white/10"
        />
      </div>
    </section>
      ...
      <div class="dropdown dropdown-end">
        ...
        >
          <div class="w-10 rounded-full">
            <img src="/user.jpg" alt="UserImagem" />
          </div>
        </button>
        <ul
          tabindex="0"
